...
int CG (fermion_field& x, const fermion_field& b, double eps = 1.e-15, int max_iterations = 1e4);
...
// returns number of times Dirac operator D was called
int SCG (std::vector<fermion_field>& x, const fermion_field& b, std::vector<double>& sigma, double eps = 1.e-15, double eps_shifts = 1.e-15, int max_iterations = 1e4);
